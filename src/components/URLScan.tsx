...
export function URLScan({ onBack }: URLScanProps) {
  ...
  const handleScan = async () => {
    ...
    try {
      const response = await fetch("http://127.0.0.1:5000/analyze", {
        ...
        body: JSON.stringify({ url }), // ⬅️ send URL to backend
      });
      ...
      setResult({
        ...
        url,
        analysis: {
          domainReputation: fake > real ? "Flagged" : "Trusted",
          contentQuality: fake > real ? "Low Quality" : "High Quality",
          sourceCredibility: fake > real ? "Unverified" : "Established Media",
          factChecking: fake > real ? "No Verification" : "Cross-Referenced",
        },
        hateSpeech: data.hate_speech || null, // ✅ include hate speech
        metadata: {
          domain: new URL(url.startsWith("http") ? url : "https://" + url)
            .hostname,
          lastUpdated: new Date().toLocaleDateString(),
          sources: Math.floor(Math.random() * 20) + 5, // optional placeholder
        },
      });
    } catch (err) {
      console.error("Error analyzing URL:", err);
      alert("Something went wrong while analyzing the URL. Check backend.");
    } finally {
      setIsScanning(false);
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center">
            <Link className="w-8 h-8 text-cyan-400 mr-3" />
            <h1
          ...
          <div className="relative z-10">
            <div className="flex items-center mb-6">
              ...
              <span
                ...
                style={{ fontFamily: "Lexend Deca, sans-serif" }}
              >
                Web Content Verification System
              </span>
            </div>
            ...
            {!result ? (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      style={{ fontFamily: "Lexend Deca, sans-serif" }}
                    />
                    <ExternalLink className="absolute right-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-500" />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div className="bg-gray-800/50 rounded-lg p-4 text-center">
                    ...
                    <div className="text-gray-400">Reputation & History</div>
                  </div>
                  <div className="bg-gray-800/50 rounded-lg p-4 text-center">
                    <div className="text-cyan-400 font-bold mb-1">
                      Content Extraction
                    </div>
                    <div className="text-gray-400">Automatic Text Analysis</div>
                  </div>
                  <div className="bg-gray-800/50 rounded-lg p-4 text-center">
                    <div className="text-cyan-400 font-bold mb-1">
                      Cross-Reference
              ...
              >
                ...
                <div className="bg-gray-800/50 rounded-lg p-4">
                  ...
                  <div className="text-gray-300 break-all">{result.url}</div>
                  <div className="text-sm text-gray-500 mt-2">
                    Domain: {result.metadata.domain} • Sources:{" "}
                    {result.metadata.sources} • Updated:{" "}
