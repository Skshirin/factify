# ai-model/finetune_distilbert_with_newsapi.py
...
# ========== 2️⃣ (Optional) Fetch Live News from NewsAPI ==========
USE_NEWSAPI = True
if USE_NEWSAPI:
    api_key = "43e46d91522c4b75aa37f75b28fce181"
    ...
    if live_data:
        ...
        print(f"Augmented dataset with {len(df_live)} live news → New shape: {df.shape}")
...
training_args = TrainingArguments(
    output_dir="./ai-model/results",
    num_train_epochs=2,
    per_device_train_batch_size=16,
    per_device_eval_batch_size=32,
    warmup_steps=50,
    weight_decay=0.01,
    logging_dir="./ai-model/logs",
    evaluation_strategy="steps",  # Evaluate at same step interval
...
# ========== 5️⃣ Save Model ==========
save_dir = "ai-model/distilbert-fake-news_finetuned"
